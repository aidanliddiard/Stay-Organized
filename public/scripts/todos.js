...
function toggleDone() {
  hideDone = !hideDone;
  fetchAndDisplayTodos();
  document.getElementById("toggleDone").innerText = hideDone
    ? "Show All"
    : "Hide Done";
}
  ...
  for (let todo of allTodos) {
    let todoCard = `
      ...
      todo.description
                    ...
                    <div class="flex justify-between">
                        <button class="delete-button border border-gray-300 shadow-sm p-1 rounded" onclick="deleteTodo(${
                          todo.id
                        })">
                        ...
                        } complete-button border border-gray-300 shadow-sm p-1 rounded" onclick="completeTodo(${
      todo.id
    })">
